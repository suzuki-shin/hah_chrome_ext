var p, CTRL_KEYCODE, ALT_KEYCODE, ITEM_TYPE_OF, SELECTOR_NUM, WEB_SEARCH_LIST, KEY, FORM_INPUT_FIELDS, CLICKABLES, _HINT_KEYS, HINT_KEYS, k1, v1, k2, v2, keyCodeToIndex, indexToKeyCode, isHitAHintKey, isFocusingForm, keyMapper, makeSelectorConsole, Main, NeutralMode, SelectorMode, HitAHintMode, FormFocusMode;
p = prelude;
CTRL_KEYCODE = 17;
ALT_KEYCODE = 18;
ITEM_TYPE_OF = {
...
console.log(KEY);
chrome.storage.sync.get('test', function(d){
